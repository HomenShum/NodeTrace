...
const packet=dirname(fileURLToPath(import.meta.url)),out=join(packet,'E6d-nodetrace-raw-before');mkdirSync(out);
...
try{
 ...
 const cases=[['actual',320,800,'no-preference'],['actual',390,844,'no-preference'],['actual',1024,768,'no-preference'],['actual',1440,960,'no-preference'],['short',390,844,'no-preference'],['long',390,844,'no-preference'],['actual',390,844,'reduce']];
