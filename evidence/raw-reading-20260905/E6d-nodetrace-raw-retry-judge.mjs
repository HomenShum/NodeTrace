...
const R='D:/VSCode Projects/cafecorner_nodebench/nodebench_ai4/NodeTrace',P=dirname(fileURLToPath(import.meta.url)),O=join(P,'E6d-nodetrace-raw-retry-judge');
...
try{
 ...
 check('recovered Raw contains current selected complete step',JSON.stringify(payload.activeStep)===JSON.stringify(source.coach.steps[0]));
